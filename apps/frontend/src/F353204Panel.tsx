...
export function F353204Panel({ disabled = false, onStatusChange }: F353204PanelProps) {
  ...
  async function handleCommitFha(): Promise<void> {
    ...
    try {
      ...
      setFhaMessage(
        `FHA committed: ${result.imported} FC, linked SDF ${result.linked_sdf_count}, unlinked FC ${(result.unlinked_failure_condition_ids ?? []).length}.`
      );
      updateStatus("FHA imported and linked to SystemDataFlow nodes.");
    } finally {
      setBusy(false);
    }
  }
        ...
        <>
          ...
          <div className="scroll-panel f3532-04-editor">
            ...
            <table className="report-table">
              <thead>
                <tr>
                  <th>TC</th><th>FHA</th><th>Function</th><th>CIA</th><th>Description</th><th>Aircraft Effect</th><th>System Effect</th><th>Crew Effect</th><th>Occupant Effect</th><th>Severity</th><th>Paths</th>
                </tr>
              </thead>
              <tbody>
